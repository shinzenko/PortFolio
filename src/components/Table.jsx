      ...
      <div
        className={`${
          selectedId === item.id
            ...
            : "border-[#d4d4d4]"
        } w-[20%] bg-[#121212] lg:border-l-[2px] flex flex-wrap border-[#d4d4d4] text-[#d4d4d4] flex flex-col transition-all duration-500 md:flex-row md:border-t-[2px]`}
      >
        <button
          className={`${
        ...
        >
          <span className="font-['Baskervville_SC']">{item.button}</span>
        </button>
      </div>
    </>
  );
